...
class LookerConfig(BaseSettings):
    ...
    default_folder_id: Optional[str] = Field(default=None, env="LOOKER_DEFAULT_FOLDER_ID")
...
class RedisConfig(BaseSettings):
    ...
    schema_cache_ttl: int = Field(default=86400, env="REDIS_SCHEMA_CACHE_TTL")  # 24 hours
...
class MonitoringConfig(BaseSettings):
    ...
    jaeger_service_name: str = Field(default="thrasio-worker", env="JAEGER_SERVICE_NAME")
...
class WorkerConfig(BaseSettings):
    ...
    dead_letter_queue: str = Field(default="data_analysis_dlq", env="WORKER_DEAD_LETTER_QUEUE")
